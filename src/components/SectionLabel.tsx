...
export function StatTile({
  ...
  return (
    <div
      className={cn(
        "rounded-[18px] bg-card border border-[oklch(0.34_0.032_290/0.5)] px-3.5 py-3.5",
        className,
      )}
    >
      <div className="font-display text-[24px] leading-[1.1] tracking-[-0.04em]">{value}</div>
      <div className="mt-0.5 text-[9.5px] font-bold uppercase tracking-[0.14em] text-muted-foreground whitespace-nowrap">
        {label}
      </div>
    </div>
  );
